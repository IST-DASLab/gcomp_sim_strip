...
log_writer = SummaryWriter(args.log_dir) if rank == 0 else None
...
compression=None
if args.distributed:
    # Create your compressor here.
    # compression = gcomp_sim.SanityCompressor()
    compression = gcomp_sim.NoneCompressor()
    ...
    comp_state = gcomp_sim.SimCompressionState(torch.distributed.group.WORLD, compressor=compression, named_parameters=model.named_parameters())
